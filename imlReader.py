...
list = [ name for name in os.listdir("/Users/gentleman/dropbox/thesis/xml") if os.path.isdir(os.path.join("/Users/gentleman/dropbox/thesis/xml", name)) ]
for file in list:
	os.chdir("/Users/gentleman/dropbox/thesis/xml/"+file)  #作業ディレクトリの移動
